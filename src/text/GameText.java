...
public abstract class GameText extends Text {
  ...
  String getGameOverScoreId() { return properties.getProperty("game_over_score_id"); }
  int getGameOverScoreAmountShown() { return Integer.parseInt(properties.getProperty("game_over_score_amount"));}
  int getGameOverScoreXPosition() { return Integer.parseInt(properties.getProperty("game_over_score_x_position"));}
